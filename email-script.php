...
if(isset($_POST['submit'])){
    ...
    if($uploadStatus == 1){
        // Recipient
        $toEmail = 'kirti.gaba@velocitai.com';
        // Sender
        $from = $email;
        $fromName = $email;
        // Subject
        ...
        // Message
        $htmlContent = "From:".$name."\n\n"."Description:".$message."\n\n"."Mobile Number:".$phone."\n\n"."Current Salary:".$csalary."\n\n"."Expected Salary:".$esalary."\n\n"."Degree:".$degree."\n\n"."Notice Period:".$nperiod;
        ...
        // If mail sent
        if($mail){
            $statusMsg = 'Your job application has been submitted successfully!';
        }else{
